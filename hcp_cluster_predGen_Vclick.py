...
k = 'parcel_connection'
run_uid = '89952a'
outpath = f'/data/hx-hx1/kbaacke/datasets/hcp_analysis_output/{run_uid}/'
...
fs_outpath = f'/data/hx-hx1/kbaacke/datasets/hcp_analysis_output/{run_uid}/FeatureSelection/'
