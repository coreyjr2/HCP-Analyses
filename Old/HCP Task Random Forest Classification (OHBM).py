...
HCP_DIR = "~/HCP/"
HCP_DIR_REST = "~HCP/hcp_rest/subjects/"
HCP_DIR_TASK = "~HCP/hcp_task/subjects/"
HCP_DIR_EVS = "~HCP/hcp_task/"
HCP_DIR_BEHAVIOR = "~/HCP/hcp_behavior/"
...
demographics = pd.read_csv('~HCP/HCP_demographics/demographics_behavior.csv')
...
regions = np.load("~HCP/hcp_rest/regions.npy").T
region_info = dict(
