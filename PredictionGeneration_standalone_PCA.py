...
# feature_index_length = len(feature_set_dict[k]['hierarchical_selected_features'][level])
# sub_train_x = feature_set_dict[k]['train_pca'][:,:feature_index_length]
# sub_test_x = feature_set_dict[k]['test_pca'][:,:feature_index_length]
